/* global webix, Utiles, ace, Infinity */
...
webix.protoUI({
    ...
    _render_cm_editor: function () {
        webix.require([
            Utiles.getContextPath() + "/dlsdkweb/web/externos/webix/ace/src-min-noconflict/ace.js"
        ], this._render_when_ready, this);
    },

    _render_when_ready: function () {
        var basePath = Utiles.getContextPath() + "/dlsdkweb/web/externos/webix/ace/src-min-noconflict/";
    ...
    attachOnBlur: function (fncOnBlur) {
        this.getEditor(true).then(function (editor) {
            editor.onBlur = fncOnBlur;
        });
    },

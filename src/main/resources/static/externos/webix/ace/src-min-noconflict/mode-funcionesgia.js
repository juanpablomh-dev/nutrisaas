ace.define("ace/mode/funcionesgia_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules"], function (e, t, n) {
    "use strict";
    var r = e("../lib/oop"),
            i = e("../lib/lang"),
            s = e("./text_highlight_rules").TextHighlightRules,
            o = function () {
                var highlightWords = i.arrayToMap(obtenerFunciones().split("|"));
                var highlightDataTypes = i.arrayToMap("STRING|DATE|INT|OBJECT|DOUBLE".split("|"));
                this.$rules = {
                    start: [
                        {
                            token: "comment",
                            ...
                            token: function (i) {
                                return highlightWords.hasOwnProperty(i.toUpperCase()) ? "constant.language" :
                                        highlightDataTypes.hasOwnProperty(i.toUpperCase()) ? "variable.language" : "text"
                            },
                            regex: "\\-?[@a-z_][@a-z0-9_\\-\\$]*"
                        }, {
    ...
    r.inherits(o, s), t.FuncionesGIAHighlightRules = o
                ...
                this.add("braces", "insertion", function (e, t, n, r, i) {
                    ...
                    if (i == "{") {
                        ...
                        if (h.isSaneInsertion(n, r))
                            return /[\]\}\)]/.test(u[s.column]) || n.inMultiSelectMode ? (h.recordAutoInsert(n, r, "}"), {
                                text: "{}",
                                selection: [1, 1]
                        ...
                        if (p == "}") {
                            ...
                            if (d !== null && h.isAutoInsertedClosing(s, u, i))
                                return h.popAutoInsertedClosing(), {
                                    text: "",
                                    selection: [1, 1]
                                }
                        }
...
}), ace.define("ace/mode/funcionesgia", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/funcionesgia_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/css", "ace/mode/folding/cstyle"], function (e, t, n) {
    "use strict";
    var r = e("../lib/oop"),
            i = e("./text").Mode,
            s = e("./funcionesgia_highlight_rules").FuncionesGIAHighlightRules,

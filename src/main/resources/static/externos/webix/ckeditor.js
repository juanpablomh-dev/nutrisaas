...
webix.protoUI({
    ...
    _init_ckeditor_once: function () {
        ...
        window.CKEDITOR_BASEPATH = Utiles.getContextPath() + "/dlsdkweb/web/externos/webix/ckeditor/";
        webix.require(Utiles.getContextPath() + "/dlsdkweb/web/externos/webix/ckeditor/ckeditor.js", function () {
    ...
    _set_inner_size: function (x, y) {
        if (!this._3rd_editor || !this._3rd_editor.container || !this.$width)
            return;

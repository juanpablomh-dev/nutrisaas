...
webix.protoUI({
    ...
    $init: function (config) {
        this.$view.innerHTML = "<div style='padding:10px'>Cargando...</div>";
    ...
    _init_nic_editor: function () {
        ...
        var cdn = this.config.cdn ? this.config.cdn : Utiles.getContextPath() + "/dlsdkweb/web/externos/webix/nicedit";
